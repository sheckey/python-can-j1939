...
class ElectronicControlUnit:
    ...
    def send_pgn(self, data_page, pdu_format, pdu_specific, priority, src_address, dest_address, data, time_limit=0, frame_format=FrameFormat.FEFF):
        """send a pgn
        ...
        """
        return self.j1939_dll.send_pgn(data_page, pdu_format, pdu_specific, priority, src_address, dest_address, data, time_limit, frame_format)
